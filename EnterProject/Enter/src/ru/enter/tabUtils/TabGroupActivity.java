...
import ru.enter.ProductListActivity;
...
public class TabGroupActivity extends ActivityGroup {
	...
	public void finishFromChild(Activity child) {
		...
		Activity activity = manager.getActivity(lastId);
		Intent lastIntent = activity.getIntent();
	...
	public void runNext(Intent intent,String tag){
		TabGroupActivity parentActivity = (TabGroupActivity)getParent();
		parentActivity.startChildActivity(tag, intent);
	}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode==123){
			ProductListActivity activity = (ProductListActivity)getLocalActivityManager().getActivity(mIdList.get(mIdList.size() - 1));
