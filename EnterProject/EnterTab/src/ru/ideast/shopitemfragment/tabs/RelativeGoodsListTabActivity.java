...
public class RelativeGoodsListTabActivity extends GridTabActivity {
	
	public static String P_BEAN = "theBeanRel";
	...
	void setAdapterToListView() {
		...
		adapter = new ProductCardProductsGridAdapter(this, pBean.getRelated());
	...
	private OnClickListener mClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.product_card_tab_products_button_buy:
				...
				Activity activity = RelativeGoodsListTabActivity.this;
				dialog.show(activity.getFragmentManager(), "basket_add");
				break;
			case R.id.product_card_tab_products_relative_main:
				Intent intent = new Intent(RelativeGoodsListTabActivity.this, ProductCardActivity.class);
