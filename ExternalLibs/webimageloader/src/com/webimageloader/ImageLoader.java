...
public class ImageLoader {
    ...
    private int diskCache, threadCount, memoryCacheSize;
...
/*
  ...
  */  
    private ImageLoader(Context context, String pathCacheFolder, int diskCache, int threadCount, int memoryCacheSize) {
    	this.pathCacheFolder=pathCacheFolder;
    	this.diskCache = diskCache;
    	this.memoryCacheSize = memoryCacheSize;
    	this.diskCache = diskCache;
    	this.threadCount=threadCount;
    	this.context = context;
    	NetworkLoader.Builder networkBuilder = new NetworkLoader.Builder();
    	MemoryCache memoryCache = new MemoryCache(memoryCacheSize);
        
    	File cacheDir = IOUtil.getDiskCacheDir(context, pathCacheFolder);
    	DiskLoader diskLoader = null;
    	 try {
             diskLoader = DiskLoader.open(cacheDir, diskCache, threadCount);
         } catch (IOException e) {
        ...
        loaderManager = new LoaderManager(memoryCache, diskLoader, networkLoader);
...
/*
    ...
    */
    ...
    public static class NewBuilder {
        ...
        public NewBuilder enableDiskCache(String pathCacheFolder, int maxSize) {
            return enableDiskCache(pathCacheFolder, maxSize, Constants.DEFAULT_DISK_THREADS);
        }

        public NewBuilder enableDiskCache(String pathCacheFolder, int maxSize, int threadCount) {
            this.pathCacheFolder = pathCacheFolder;
            this.diskCache=maxSize;
            this.threadCount=threadCount;
            return this;
        }

        public NewBuilder enableMemoryCache(int maxSize) {
            this.memoryCacheSize = maxSize;

            return this;
        }

        public ImageLoader build() {
            return new ImageLoader(context,pathCacheFolder,diskCache,threadCount,memoryCacheSize);
        }
    }
